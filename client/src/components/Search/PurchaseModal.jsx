  ...
  const handlePurchase = async (e) => {
    ...
    try {
      ...
      if (response.data.status === "success") {
        ...
        setErrorMessage(response.data.message || "Purchase failed.");
      }
    } catch (err) {
          ...
          <CardContent>
            ...
            <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
              ...
              <Typography variant="body2" align="center">
                Cash Balance after purchase: {userData ? "$" + (userData.user.balance - total).toLocaleString() : "Balance Unavailable"}
              </Typography>
